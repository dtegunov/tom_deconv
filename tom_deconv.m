function [ deconv ] = tom_deconv_tomo( vol, angpix, defocus, snrfalloff, deconvstrength, highpassnyquist, phaseflipped, phaseshift )
...
%
% phaseshift:
% CTF phase shift in degrees (e. g. from a phase plate)
%
%
% Usage example:
...
ctf = tom_ctf1d(2048, angpix*1e-10, 300e3, 2.7e-3, -defocus*1e-6, 0.07, phaseshift / 180 * pi, 0);
if phaseflipped
    ctf = abs(ctf);
end;
